...
// Also all synchronized attrtibutes are removed
...
class ArrayHashtableEntry {
    ...
    static boolean equalsArray(Object[] aArray, Object[] bArray) {
        int lth = aArray.length;
    ...
    boolean keyEquals(Object anObject) {
        ...
        if (key instanceof Object[] && anObject instanceof Object[]) {
            return equalsArray((Object[])key, (Object[])anObject);
        }
        return key.equals(anObject);
    }
    ...
    boolean valueEquals(Object anObject) {
        ...
        if (value instanceof Object[] && anObject instanceof Object[]) {
            return equalsArray((Object[])value, (Object[])anObject);
        }
