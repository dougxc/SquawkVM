...
class DataOutputStream extends OutputStream implements DataOutput {
     ...
     */
/*FLT*/public final void writeFloat(float v) throws IOException {
/*FLT*/    writeInt(Float.floatToIntBits(v));
/*FLT*/}
     ...
     */
/*FLT*/public final void writeDouble(double v) throws IOException {
/*FLT*/    writeLong(Double.doubleToLongBits(v));
/*FLT*/}
