...
\*---------------------------------------------------------------------------*/
    ...
    int _SQUAWK_INTERNAL_primitive(int[] ar, int code, Object rs1, int rs2) throws Throwable {
        throw new RuntimeException(getClass().getName() + ".primitive(int[], int, Object, int) is undefined");
    }
    ...
    void _SQUAWK_INTERNAL_main(String[] args) {
        throw new RuntimeException(getClass().getName() + ".main(String[]) is undefined");
    }


/*---------------------------------------------------------------------------*\
 *                            Regular Object things                          *
\*---------------------------------------------------------------------------*/
...
//            return Native.asClass(ClassBase.metaClass());
//        } else {
            return Native.getClass(this);
//        }
    }
     ...
     */
    public int hashCode() {
        return Thread.getHashCode(this);
    }
