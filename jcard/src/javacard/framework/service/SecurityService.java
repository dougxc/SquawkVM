...
/*
 *   @(#)SecurityService.java	1.11 02/03/14
 */
 ...
 * extends the base <CODE>Service</CODE> interface and defines methods to query the current
 * security status.
 ...
 * initialization is assumed to be performed through <CODE>APDU</CODE> commands that
 * the service is able to process.
 * <p>A security service implementation class should extend <CODE>BasicService</CODE>
...
public interface SecurityService extends Service {
  ...
  * checking of the incoming command. Note that this is a bit mask and security
  * properties can be combined by simply adding them together.
  */
  ...
  * generation for the outgoing response. Note that this is a bit mask and security
  * properties can be combined by simply adding them together.
  */
  ...
  */
  ...
  /**
  * Checks whether a secure channel is established between the card and the host for
  * the ongoing session that guarantees the indicated properties.
